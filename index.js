...
const backgroundFile = "img/moon.jpg";
...
const changeBackground = () => document.body.style.background = `url(${backgroundFile}) no-repeat center`;
...
// const disableOverflow = () => window.html.style.overflow = 'hidden';
